...
public class PieChart3DShow extends ApplicationFrame {
	private static double cs;
	private static double cls;
	private static double ncs;

	public PieChart3DShow(double cs, double cls, double ncs) {
		super("กราฟวงกลม 3D");
		this.cs = cs;
		this.cls = cls;
		this.ncs = ncs;
	...
	private static JFreeChart createChart(PieDataset dataset) {
		JFreeChart chart = ChartFactory.createPieChart3D("เปอร์เซนต์ของนักเรียนในการเข้าร่วมกิจกรรม", dataset, true, true, false);
		return chart;
	}
